...
WOLFSSL_CONF_OPTS = -DWOLFSSL_ASM=yes -DWOLFSSL_EXAMPLES=no -DWOLFSSL_CRYPT_TESTS=no -DWOLFSSL_OLD_TLS=no -DWOLFSSL_QUIC=yes -DWOLFSSL_CURL=yes -DWOLFSSL_AES_ECB=yes -DCMAKE_C_FLAGS="-Wno-stringop-overflow"
