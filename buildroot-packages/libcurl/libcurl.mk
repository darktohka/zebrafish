...
ifeq ($(BR2_PACKAGE_NGTCP2),y)
LIBCURL_DEPENDENCIES += ngtcp2
LIBCURL_CONF_OPTS += --with-ngtcp2
else
LIBCURL_CONF_OPTS += --without-ngtcp2
endif

ifeq ($(BR2_PACKAGE_NGHTTP3),y)
LIBCURL_DEPENDENCIES += nghttp3
LIBCURL_CONF_OPTS += --with-nghttp3
else
LIBCURL_CONF_OPTS += --without-nghttp3
endif
