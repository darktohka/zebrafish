...
NGHTTP2_CONF_OPTS = -DENABLE_LIB_ONLY=ON -DBUILD_STATIC_LIBS=OFF -DBUILD_SHARED_LIBS=ON -DENABLE_EXAMPLES=OFF -DENABLE_APP=OFF -DENABLE_HPACK_TOOLS=OFF -DENABLE_LIB_ONLY=ON -DENABLE_DOC=OFF -DBUILD_TESTING=OFF -DWITH_WOLFSSL=ON -DENABLE_HTTP3=ON
