...
NGHTTP2_CONF_OPTS = -DBUILD_STATIC_LIBS=OFF -DBUILD_SHARED_LIBS=ON -DENABLE_EXAMPLES=OFF -DENABLE_DOC=OFF -DBUILD_TESTING=OFF -DWITH_WOLFSSL=ON -DENABLE_HTTP3=ON
